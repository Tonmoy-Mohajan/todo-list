...
addtaskbtn.addEventListener("click", function(){
    ...
    if(addtaskinputval.trim()!=0){
		...
		// console.log(taskObj, 'marjan piku');
...
function showtask(){
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    ${taskCompleteValue}
                    <td><button type="button" class="text-success" id=${index}  onclick="togglePopup()"><i class="fa fa-check-square-o"></i>&nbsp &nbsp</button></td>
